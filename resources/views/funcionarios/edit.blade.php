...
@section('content')
    <h3>Editando Funcionários:{{ $funcionario->nome_fun }}</h3>
    ...
    <div class="form-group">
        ...
        {!! Form::text('nome_fun', $funcionario->nome_fun, ['class'=>'form-control', 'required']) !!}
    </div>

    <div class="form-group">
        {!! Form::label('telefone', 'Telefone:') !!}
        {!! Form::text('telefone', $funcionario->telefone, ['class'=>'form-control', 'id'=>'telefone', 'name'=>'telefone', 'placeholder'=>'(00) 0000-0000', 'required']) !!}
    </div>
